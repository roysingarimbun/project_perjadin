 <?php
    if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
        ...
        switch ($act) {
            default:
                $mstbendahara = mysql_query("SELECT * FROM mstbendahara ");
                $count = mysql_num_rows($mstbendahara);
    ?>
             <style type="text/css">
                 <!--
                 .style2 {
                     ...
                     <div class="container-fluid">
                         <form method="post" name="frm">
                             <div class="panel-heading">
                                 <h4 class="panel-title style3">BENDAHARA</h4>
                                 <p></p>
                                 <?php
                                 ...
                                 <?php if ($level == 'admin') { ?>
                                     <div class="col-xl-12">
                                         ...
                                         <a class="btn btn-rounded btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=mstbendahara&act=tambahmstbendahara"><i class="fa fa-send"></i> Tambah</a>
                                         <button class="btn btn-rounded btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit" onClick="update_records_mstbendahara();"><i class="fa fa-edit"></i> Edit</button>
                                         <button class="btn btn-rounded btn-danger waves-effect waves-light" title="Hapus" data-toggle="tooltip" data-placement="top" onClick="delete_records_mstbendahara();"><i class="fa fa-remove"></i> Hapus </button>
                                     <?php } ?>

                                     <?php
                                        if ($count > 0) {
                                        ?>
                                         <button class="btn btn-warning btn-rounded waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="lihat" onClick="view_records_mstbendahara();"><i class="fa fa-desktop"></i> Lihat</button>
                                     ...
                                     <div class="panel-container show">
                                         <div class="panel-content" style="overflow-x: auto">
                                             <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100" style="text-align: center; vertical-align: middle;">
                                                 <thead>
                                                     <tr>
                                                         <th colspan="6"><span class="style2">BENDAHARA</span></th>
                                                     </tr>
                                                 </thead>
                                                 <tbody>
                                                     <tr>
                                                     ...
                                                     <?php
                                                        $no = 1;
                                                        $bag = mysql_query("select * from mstbendahara order by id ");
                                                        while ($bg = mysql_fetch_array($bag)) { ?>
                                                         <tr>
                                                             ...
                                                             <td><?php echo " $no"; ?></td>
                                                             <td><?php echo " $bg[nip_bend]"; ?></td>
                                                             <td><?php echo " $bg[nama_bend]"; ?></td>
                                                             <td><?php echo " $bg[kdunit_bend]"; ?></td>
                     ...
                     <div class="container-fluid">
                         ...
                         <div class="row">
                             <div class="col-12">
                                 <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                     <h4 class="mb-sm-0 font-size-18">TAMBAH BENDAHARA</h4>
                         ...
                         <div class="panel-container show">
                             ...
                             <div class="panel-content p-0">
                                 <form class="needs-validation" novalidate action="<?php echo $aksi; ?>?module=mstbendahara&act=input" id="js-simpandata" method="POST">
                                     ...
                                     <div class="panel-content">
                                         <div class="row">
                                             <div class="col-md-5 mb-10">
                                                 ...
                                                 <div class="input-group">
                                                     <input type="text" name="nip_bend" class="form-control" id="validationTooltip03" placeholder="Isi NIP" aria-describedby="inputGroupPrepend2" required>
                                         ...
                                         <div class="row">
                                             <div class="col-md-5 mb-10">
                                                 ...
                                                 <div class="input-group">
                                                     <input type="text" name="nama_bend" class="form-control" id="validationTooltip03" placeholder="Isi Nama" aria-describedby="inputGroupPrepend2" required>
                                         ...
                                         <div class="row">
                                             <div class="col-md-5 mb-3">
                                                 ...
                                                 <input type="text" name="namaunit" class="form-control" id="validationTooltip03" aria-describedby="inputGroupPrepend2" value="
														<?= $namaunit['nama_unit'] ?>" readonly>
                                     ...
                                     <div class="form-row form-group">
                                         <div class="col-md-6 mb-3">
                                             <a type="submit" href="perjadin.php?module=mstbendahara" class="btn btn-danger"></i> Kembali</a>
