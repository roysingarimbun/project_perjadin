					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-12">
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									<h4 class="mb-sm-0 font-size-18">EDIT DATA SATKER</h4>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xl-10">
								<div class="card">
									<div class="card-body">
										<form class="needs-validation" novalidate action="<?php echo $aksi; ?>?module=mstdata_satker&act=update" method="POST">
											...
											<div class="row">
												<div class="col-md-3">
													<div class="mb-3">
														...
														<input type="text" name="kode_satker" class="form-control" id="kode_satker" placeholder="Isi Kode Satker" value="<?php echo $r[kode_satker]; ?>" required>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="mb-3">
														...
														<input type="text" name="nama_satker" class="form-control" id="nama_satker" placeholder="Isi Nama Satker" value="<?php echo $r[nama_satker]; ?>" required>
														<div class="invalid-tooltip">
