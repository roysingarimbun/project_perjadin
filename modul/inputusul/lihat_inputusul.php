                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">LIHAT NAMA JABATAN</h4>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                   <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=mstjabatan" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kodejab" class="form-control" id="kodejab"
                                                   placeholder="Kode Jabatan" value="<?php echo $r[kodejab];?>" readonly>
                                            </div>
                                        </div>
									</div>
									...
									<div class="col-md-10">
										 <a type="submit"  href="perjadin.php?module=mstjabatan" class="btn btn-rounded btn-danger waves-effect waves-light">Kembali</a>
