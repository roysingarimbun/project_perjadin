                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Pangkat Golongan</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-10">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="<?php echo $aksi; ?>?module=mstpangkat&act=update" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="namapangkat" class="form-control" id="namapangkat" placeholder="Isi Nama Pangkat" value="<?php echo $r[namapangkat]; ?>" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="kodegol" class="form-control" id="kodegol" placeholder="Isi Kode Golongan" value="<?php echo $r[kodegol]; ?>" required>
                                                        <div class="invalid-tooltip">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="ruang" class="form-control" id="ruang" placeholder="Isi Ruang" value="<?php echo $r[ruang]; ?>" required>
                                                        <div class="invalid-tooltip">
