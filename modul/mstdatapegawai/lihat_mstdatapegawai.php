                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">LIHAT DATA PEGAWAI</h4>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                   <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=mstdatapegawai" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="peg_iduser" class="form-control" id="peg_iduser"
                                                   placeholder="Kode Jabatan" value="<?php echo $r[peg_iduser];?>" readonly>
                                            </div>
                                        </div>
									</div>
									...
									<div class="col-md-10">
										 <a type="submit"  href="perjadin.php?module=mstdatapegawai" class="btn btn-rounded btn-danger waves-effect waves-light">Kembali</a>
