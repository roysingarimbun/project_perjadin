                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">HAPUS KABUPATEN / KOTA</h4>
                        ...
                        <div class="row">
                            <div class="col-xl-10">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class="needs-validation" novalidate action="<?php echo $aksi; ?>?module=mstkota&act=hapus" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="kode_kota" class="form-control" id="kode_kota" value="<?php echo $r[kode_kota]; ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <a type="submit" href="perjadin.php?module=mstkota" class="btn btn-rounded btn-primary waves-effect waves-light">Batal</a>
