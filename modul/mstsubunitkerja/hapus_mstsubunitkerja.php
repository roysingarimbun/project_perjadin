                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Hapus Sub Unit Kerja</h4>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=mstsubunitkerja&act=hapus" method="POST" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_unit_kerja" class="form-control" id="nama_unit_kerja"
                                                   placeholder="Nama Unit Kerja" value="<?php echo $r[nama_unit_kerja];?>" readonly>
                                            </div>
                                        </div>
								    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kodesub_unit" class="form-control" id="kodesub_unit"
                                                   placeholder="Kode Sub Unit Kerja" value="<?php echo $r[kodesub_unit];?>" readonly>
                                            </div>
                                        </div>
								    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="namasub_unit" class="form-control" id="namasub_unit"
                                                   placeholder="Nama Sub Unit Kerja" value="<?php echo $r[namasub_unit];?>" readonly>
                                            </div>
                                        </div>
								    </div>
									...
									<div class="col-md-10">
                                        <button name="hapus_data" class="btn btn-rounded btn-danger waves-effect waves-light">Hapus</button>
										 <a type="submit"  href="perjadin.php?module=mstsubunitkerja" class="btn btn-rounded btn-primary waves-effect waves-light">Batal</a>
