                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Edit Unit Kerja</h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=mstunitkerja&act=update" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kode_unit" class="form-control" id="kode_unit"
                                                   placeholder="Isi Kode Unit" value="<?php echo $r[kode_unit];?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_unit" class="form-control" id="nama_unit"
                                                   placeholder="Isi Nama Unit"  value="<?php echo $r[nama_unit];?>" required>
                                                <div class="invalid-tooltip">
                                                    Data Harus Diisi
                                                </div>
                                            </div>
