                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Edit Tahun Anggaran</h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=msttahunanggaran&act=update" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kode_tahun" class="form-control" id="kode_tahun"
                                                   placeholder="Isi Kode Tahun" value="<?php echo $r[kode_tahun];?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="thn_anggaran" class="form-control" id="thn_anggaran"
                                                   placeholder="Isi Tahun Anggaran"  value="<?php echo $r[thn_anggaran];?>" required>
                                                <div class="invalid-tooltip">
