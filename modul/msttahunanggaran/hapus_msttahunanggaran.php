                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Hapus Tahun Anggaran</h4>
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=msttahunanggaran&act=hapus" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kode_tahun" class="form-control" id="kode_tahun"
                                                   placeholder="Hapus Data Kode Tahun" value="<?php echo $r[kode_tahun];?>" readonly>
                                            </div>
                                        </div>
									</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="thn_anggaran" class="form-control" id="thn_anggaran"
                                                   placeholder="Hapus Data Tahun Anggaran" value="<?php echo $r[thn_anggaran];?>" readonly>
                                            </div>
                                        </div>
									</div>										
									...
									<div class="col-md-10">
                                        <button name="hapus_data" class="btn btn-rounded btn-danger waves-effect waves-light">Hapus</button>
										 <a type="submit"  href="perjadin.php?module=msttahunanggaran" class="btn btn-rounded btn-primary waves-effect waves-light">Batal</a>
