                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=mstppk&act=hapus" method="POST" >
									...
									<div class="col-md-10">
                                        <button name="hapus_data" class="btn btn-rounded btn-danger waves-effect waves-light">Hapus</button>
										 <a type="submit"  href="perjadin.php?module=mstppk" class="btn btn-rounded btn-primary waves-effect waves-light">Batal</a>
