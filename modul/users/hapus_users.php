                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Hapus Data User System</h4>
                ...
                <!-- end page title -->
                        ...
                        <div class="row">
                             <div class="col-xl-6">
                              ...
                              <div class="card">
                                <div class="card-body">
                                     <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=users&act=hapus" method="POST" >
									...
									<div class="col-md-10">
                                        <button name="hapus_data" class="btn btn-rounded btn-danger waves-effect waves-light">Hapus</button>
										 <a type="submit"  href="mod.php?module=users" class="btn btn-rounded btn-primary waves-effect waves-light">Batal</a>
