                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Lihat Tingkat Perjalanan Dinas</h4>
                    ...
                    <div class="row">
                             <div class="col-xl-10">
                              ...
                              <div class="card">
                                <div class="card-body">
                                   <form   class="needs-validation" novalidate action="<?php echo $aksi;?>?module=msttingkat_perjadin" method="POST" >
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="kode_perjadin" class="form-control" id="kode_perjadin"
                                                   placeholder="Kode Perjalanan Dinas" value="<?php echo $r[kode_perjadin];?>" readonly>
                                            </div>
                                        </div>
									</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="uraian" class="form-control" id="uraian"
                                                   placeholder="Uraian Perjalanan Dinas" value="<?php echo $r[uraian];?>" readonly>
                                            </div>
                                        </div>
									</div>
										
									<div class="col-md-10">
										 <a type="submit"  href="perjadin.php?module=msttingkat_perjadin" class="btn btn-rounded btn-danger waves-effect waves-light">Kembali</a>
